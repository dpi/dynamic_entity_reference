...
class DynamicEntityReferenceFieldDependencyTest extends KernelTestBase {
  ...
  protected function setUp() {
    ...
    // There is no reason why these entity types were chosen, just need multiple
    // types available so we can differentiate between the entity type the field
    // is attached to, versus referencable entity types.
